  ...
  return (
    <section
      className={clsx(
        ...
        featured ? 'order-first bg-purple lg:order-none' : 'bg-white',
      )}>
      <h3
        className={clsx(
        ...
        <div className='mt-8 flex justify-center'>
          <div className='relative'>
            ...
            <div
              aria-hidden='true'
              className={clsx(
                'pointer-events-none absolute inset-0 z-10 grid grid-cols-2 overflow-hidden rounded-lg bg-blue transition-all duration-300',
                activePeriod === 'Monthly'
